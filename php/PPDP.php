...
<html lang="fr">
    <head>
        <meta charset="UTF-8">
        <meta name="index" content="Politique de Protection des Données Personnelles">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="keywords" content="cinema, septième, art, films, retro, protection, données"> <!-- Mots-clés référencement-->
